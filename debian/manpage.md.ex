% sapphicmariomaker2(SECTION) | User Commands
%
% "March 26 2024"
...
sapphicmariomaker2 - program to do something

# SYNOPSIS

**sapphicmariomaker2** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**sapphicmariomaker2** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **sapphicmariomaker2** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**sapphicmariomaker2** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    sapphicmariomaker2. See **foo.conf**(5) for further details.
...
**sapphicmariomaker2** provides some return codes, that can be used in scripts:
